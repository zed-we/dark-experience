...
const SHOCKS = [
  { id: "s1", text: "Did you turn off the gas?", seconds: 9 },
  { id: "s2", text: "The door might not be locked.", seconds: 8 },
  { id: "s3", text: "Not every sound is random.", seconds: 7 },
  { id: "s4", text: "You missed a detail earlier.", seconds: 8 },
  { id: "s5", text: "Something changed.", seconds: 7 },
  { id: "s6", text: "Silence is rarely empty.", seconds: 8 },
];
...
function renderShock(s){
  const seq = renderChalkSequence(s.text, 0.45, 0.7);
